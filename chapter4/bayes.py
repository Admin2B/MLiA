...
if __name__ == '__main__':
    ...
    import feedparser
    user1_cbn=feedparser.parse('https://www1.cbn.com/app_feeds/rss/news/rss.php?section=us')
    user2_yahoo= feedparser.parse('https://news.yahoo.com/rss/')
    #ny['entries']
    #print(len(user1_cbn['entries']))

    # 如果运行的话，可以发现错误率特别高，还不如瞎蒙，这是因为他的RSS源不能使用了，我随便找的新闻RSS源
    # 原本的RSS源对应两个地区，这里完全对不上，所以错误率极高，这里仅是为了测试程序能不能运行而已。
    vocabList,pU1,pU2=localWords(user1_cbn,user2_yahoo)
    getTopWords(user1_cbn,user2_yahoo)
